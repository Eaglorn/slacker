...
@Suppress("unused") open class SlackerControllerData {
    ...
    @FXML private fun onButtonClickLoadDataBase() { Data.settingController.onButtonClickLoadDataBase() }
    @FXML private fun onButtonClickLoadTemplates() { Data.settingController.onButtonClickLoadTemplates() }

    @FXML private fun onButtonClickDBMakerAdd() { Data.dbMakerController.onButtonClickAdd() }
    @FXML private fun onButtonClickDBMakerEdit() { Data.dbMakerController.onButtonClickEdit() }
    @FXML private fun onButtonClickDBMakerDelete() { Data.dbMakerController.onButtonClickDelete() }

    @FXML private fun onButtonClickDBTypeOfHardwareAdd() { Data.dbTypeOfHardwareController.onButtonClickAdd() }
    @FXML private fun onButtonClickDBTypeOfHardwareEdit() { Data.dbTypeOfHardwareController.onButtonClickEdit() }
    @FXML private fun onButtonClickDBTypeOfHardwareDelete() { Data.dbTypeOfHardwareController.onButtonClickDelete() }

    @FXML private fun onButtonClickDBModelAdd() { Data.dbModelController.onButtonClickAdd() }
    @FXML private fun onButtonClickDBModelEdit() { Data.dbModelController.onButtonClickEdit() }
    @FXML private fun onButtonClickDBModelDelete() { Data.dbModelController.onButtonClickDelete() }

    @FXML private fun onButtonClickDBUserAdd() { Data.dbUserController.onButtonClickAdd() }
    @FXML private fun onButtonClickDBUserEdit() { Data.dbUserController.onButtonClickEdit() }
    @FXML private fun onButtonClickDBUserDelete() { Data.dbUserController.onButtonClickDelete() }
